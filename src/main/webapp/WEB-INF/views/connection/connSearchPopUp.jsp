                    ...
                    <table class="table table-striped table-hover" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                       ...
                       <tbody>
                        ...
                        <tr>
                           ...
                           <td >${c.conName}</td>
                           <td><button type="button" class="btn btn-success mr-2"
									onclick="choiceConnection()">선택</button>
                        </tr>
                     </c:forEach>
                       </tbody>
                     </table>
...
<script>
function choiceConnection() {
		
	   opener.document.getElementById("conName").value = "테스트";
	   self.close();
	}
</script>
