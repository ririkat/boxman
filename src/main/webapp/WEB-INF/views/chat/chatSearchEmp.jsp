				...
				<div class="schedule-contents bg-schedule">
					...
					<div class="tab-pane fade show active schedule-item" id="nov20">
					  	...
					  	<ul class="m-0 p-0">
							...
							<c:if test="${list2['EMPNO'] != loginEmp['EMPNO']}">
					  		<li class="schedule-details">
					  			<div class="block">
							  		...
							  		<!-- Speaker -->
							  		<div class="speaker">
										<span class="name"><c:out value='${list2["EMPNAME"] }'/></span>
							  		</div>
							  		<!-- Depart -->
							  		<div class="depart">
										<span class="name"><c:out value='${list2["JOBNAME"] }'/></span>
							  		</div>
							  		<!-- Subject -->
							  		<div class="subject">
							  			<span class="name"><c:out value='${list2["DEPTNAME"] }'/></span>
							  		</div>
							  		<!-- Venue -->
							  		<div class="venue"> <label class=""><a class="b-related btn btn-outline-success my-2 my-sm-0" href="${path }/chat/chatRoom.do?receiver=${list2['EMPNO']}&sender=${loginEmp['EMPNO'] }"><span>방열기</span></a></label></div>
					  				<c:if test="${list2['READCOUNT'] == 0}">
						  				<div class="subject">
