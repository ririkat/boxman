...
<jsp:include page="/WEB-INF/views/common/header.jsp">   
   ...
   <jsp:param value="ddd" name="pageTitle"/>
</jsp:include>
         ...
         <div class="row">
           <div class="col-md-6">
             <div class="form-group row">
               ...
               <div class="col-sm-9">
                 <input type="text" class="form-control" name="empName" value='${eList["EMPNAME"]}' readonly>
               </div>
             </div>
           </div>
           <div class="col-md-6">
             <div class="form-group row">
               ...
               <div class="col-sm-9">
                  <input type="text" class="form-control" name="empName" value='${dept["DEPTNAME"]}' readonly>
               </div>
             </div>
           </div>
         </div>
