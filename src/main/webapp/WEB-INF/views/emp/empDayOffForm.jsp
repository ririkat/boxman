								...
								<table class="table table-striped table-hover" id="dataTable"
									...
									<tbody>
										<tr>
											...
											<td><input type="text" class="datePicker pic" class="form-control" id="startDay" name="startDay" style="width:110px;"></td>
											<td><input type="text" class="datePicker pic" class="form-control" id="endDay" name="endDay" style="width:110px;"></td>
											<td>구분
												<select name="type" id="dayOffSelect"
