						...
						<div class="col-sm-12 col-md-6">
							<form id="searchFrm">
								<div class="dataTables_length" id="dataTable_length">
									...
									<label>Search: <c:choose>
											<c:when test="${temp eq 'my' or temp eq 'all'}">
												<input type="text" class="datePicker pic"
											...
											<c:when test="${temp eq 'search' or temp eq 'searchAll'}">
												<input type="text" class="datePicker1 pic"
													value="${startDay}" class="form-control" name="startDay"
													style="width: 110px;">
											-
											<input type="text" class="datePicker1 pic" value="${endDay}"
													class="form-control" name="endDay" style="width: 110px;">
											</c:when>
										</c:choose>
									</label>
									...
									<c:if test="${temp eq 'all' or temp eq 'searchAll'}">
										...
										<input type="search" class="form-control form-control-sm"
											style="width: 100px; display: inline;" placeholder=""
											aria-controls="dataTable" name="data">
									</c:if>
...
<script>
	$(function() {
		var d = new Date();
		var day = d.getFullYear() + "-" + (d.getMonth() + 1) + "-"
				+ d.getDate();
		$('#startDay').val(day);
		$('#endDay').val(day);
		$('.pic').datepicker({
