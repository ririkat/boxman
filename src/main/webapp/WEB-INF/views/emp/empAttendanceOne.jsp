					...
					<input type="hidden" value='${att["ATTENNO"]}' name="attenNo" id="attenNo"/>
						<table class="table table-striped table-hover" id="dataTable"
							...
							<tbody>
								<tr>
									...
									<td><fmt:formatDate value='${att["ATTENSTART"]}' pattern="yyyy-MM-dd"/></td>
									<td><c:out value='${att["DY"]}' /></td>
									<td><fmt:formatDate value='${att["ATTENSTART"]}' pattern="HH:mm:ss"/></td>
									<td><fmt:formatDate value='${att["ATTENEND"]}' pattern="HH:mm:ss"/></td>
						...
						<form class="form-sample" id="attUpFrm" method="post">
							...
							aria-describedby="dataTable_info" style="width: 100%;">
								...
								<tbody>
									<tr>
										<td><input type="time" name="upStart"></td>
										<td><input type="time" name="upEnd"/></td>
										<td><input type="text" class="form-control" name="upReason"/></td>
									</tr>
								</tbody>
							</table>
